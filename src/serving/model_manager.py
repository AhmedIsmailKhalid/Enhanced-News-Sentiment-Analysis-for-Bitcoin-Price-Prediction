...
class ModelManager:
    ...
    def load_model(
        self, feature_set: str, model_type: str, version: Optional[str] = None
    ) -> Dict[str, Any]:
        """
        ...
        # Load metadata
        metadata_file = model_file.parent / model_file.name.replace("model_", "metadata_").replace(
            ".pkl", ".json"
        )
        metadata = {}
